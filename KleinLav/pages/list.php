...
echo "
<div style='text-align: center; margin: 20px 0 20px 0; background-color: yellow;'>
    <form method='POST' action=''>
        <label for='search_term' style='font-weight: bold; color: #fff;'>Search Users:</label><br>
        ...
        <input type='submit' value='Search' style='padding: 10px; margin-top: 10px; border-radius: 4px; border: 1px solid #007BFF; background-color:rgb(1, 163, 66); color: white; cursor: pointer;'>
    </form>
</div>
";
